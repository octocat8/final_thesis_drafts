...
\begin{theorem}[\cite{ballico_bounds_2018}]
	Fix a partition $E \sqcup F = \{1, \ldots, d\}$ such that $E = \{a_1, \ldots, a_{d-c}\}$ and $F = {b_1, \ldots, b_c}$ for a fixed $0 < c < d$. Further consider $Y$ to be the Segre variety corresponding to the $d$ spaces - $\proj\field^{n_1}, \ldots, \proj\field^{n_d}$. 
\end{theorem}
