...
\begin{document}
Since the statement of the conjecture in 2008, there has been a substantial amount of work done to arrive at a conclusive final resolution. Some of this body of work relies on the specific geometric construction of secant varieties and how they relate to the question of computing rank and symmetric rank. This connection to geometry is not surprising because tensors as mathematical objects can also be seen as points lying in a vector space (much like vectors and matrices can be seen as representing points, as well as algebraic objects.) This chapter goes over some of the affirmative answers to Comon's conjecture, with the final section of this chapter compiling all the conditions currently known for which the conjecture holds.
...
The statement of Comon's Conjecture can now be stated in more formal notation, as introduced in the previous chapter.
...
In mathematical notation, with $f \in \field[x_1, \ldots, x_n]_d$, a homogenous polynomial of degree $d$ and $\mathbf{a}:= (a_1, \ldots, a_n)$ denoting a vector containing coefficients such that $\mathbf{a}\cdot\mathbf{x} = a_1x_1 + \cdots + a_nx_n$.  \begin{equation}
