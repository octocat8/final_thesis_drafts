...
When dealing with questions of tensor rank specifically, given an identifiable tensor, it suffices to find only one rank decomposition. This then becomes useful for the purposes of looking for a counterexample to Comon's conjecture. The likely candidate symmetric tensors must either have a symmetric rank greater than the generic rank, or these must lie in a subset of $0$-volume.
