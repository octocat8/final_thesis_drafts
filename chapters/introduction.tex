...
\nomenclature{$\reals$}{Real Numbers}%
\nomenclature{$\complex$}{Complex Numbers}%
\begin{figure}
    \centering
...
This report also covered work done previously by Comon et al. \cite{comon_symmetric_2008} where they also showed that the conjecture held for situations when the symmetric rank was at least as large as the dimension of the underlying vector space, or when the order (see \cref{defn:tensororder}) of $T$ was sufficiently large. Since 2008, the mathematical community has proved the conjecture true under various assumptions (see \cref{section:pastoverview}). 

In 2018, Shitov \cite{shitov_counterexample_2018} proposed the construction of a counterexample living in $(\complex^{800})^{\otimes 3}$ with symmetric rank at least $904$, and a rank of at most $903$. In 2024 however, an erratum published \cite{draisma_erratum_2024} pointed out an error in the original paper, rendering the conjecture still open, at least for the complex case. In the intervening time, a paper published by Wang and Seigal \cite{wang_lower_2023} demonstrated the construction of a real, order $6$, symmetric tensor with real rank $30913$ and symmetric rank $30914$, disproving the conjecture for the real case. This paper built on a method of construction developed in Shitov \cite{shitov_comons_2020}, a preprint. These ideas have also been developed further in subsequent preprints from Shitov \cite{shitov_higher_2024} and \cite{shitov_higher_2024-1}.
...
\begin{description}
    ...
    \item[Chapter 4] This chapter focuses on understanding Shitov's methodology and approach to constructing a counterexample to Comon's conjecture. The culmination of this chapter is an examination of Wang and Seigal \cite{wang_lower_2023}, a published counterexample to the conjecture. 
