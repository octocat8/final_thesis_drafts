...
\begin{definition}[Slices of a Tensor]\label{defn:tensorslicing}
    ...
    $$T_j^i:= f_j(v_i)(v_1 \otimes \cdots v_{i-1} \otimes v_{i+1} \cdots \otimes v_d)\in V_1 \otimes \cdots \otimes V_{i-1} \otimes V_{i+1} \otimes \cdots \otimes V_d =: V_{\hat{i}}.$$
...
\begin{definition}[Adjoining Slices to a Tensor along a specific mode]\label{defn:adjoiningslicesinglemode}
    ...
    Define $\tau := Adj_i(T, M) \in V_1 \otimes \cdots \otimes V_{i-1} \otimes \left( V_i \oplus \field^N \right) \otimes V_{i+1}\otimes  \cdots \otimes V_d$ in the following manner 
