...
\begin{figure}[h]
    ...
    \end{tikzpicture}
    \caption{Slicing a tensor $T$ along different modes}
\end{figure}
...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption{Adjoining a slice $A$ to a tensor $T$}
\end{figure}
...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=0.9]
        ...
        \end{tikzpicture}
    \caption{Family generated from a tensor $T$ by a slice $A$}
\end{figure}
