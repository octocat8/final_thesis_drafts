...
This thesis aims to document the mathematical progress made around Comon's Conjecture --- a question about tensor rank and symmetry. Covered within this text are some of the attempts made to prove the conjecture in various contexts, published after it was first posited in 2008. The main focus of this work centers around the tools and methodology proposed by Shitov (both from published works \cite{shitov_counterexample_2018} and preprints \cites{shitov_comons_2020,shitov_higher_2024,shitov_higher_2024-1}) that aim to construct a valid counterexample to the conjecture. The culmination of this thesis is a close examination of Wang and Seigal's paper \cite{wang_lower_2023} detailing their construction of a valid counterexample in $\reals$. The existence of a counterexample in $\complex$ is still an open question and this thesis concludes that the ideas detailed within the papers cited  provide a valid pathway to one.

\section*{Acknowledgements}
This thesis was written in consultation with Prof. N. Vannieuwenhoven and Dr. D. Taufer. Prof. Vannieuwenhoven provided the initial idea and shaped the overall direction this thesis took, and Dr. Taufer's guidance over the year helped in developing this project on a solid foundation. I am grateful to both for the structure, support and feedback they have provided over the entire course of my interaction with them. I would also like to thank the TENORS Network (HORIZON-MSCA-2023, 101120296) for their workshop "Computational Methods for Tensors in Mathematics and Quantum Physics", which provided a space to interact with other researchers working on tensor problems. This allowed me to challenge my own understanding of the subject, and develop a better understanding of the literature by applying the knowledge from this project in some of the conversations that I was privileged to have.  Personal contributions to this thesis are detailed in the introduction. Generative AI tools were not used in the writing of this thesis.

Finally, this thesis would not exist without friends, family, coworkers, and mentors. Without this support network, both in Belgium and around the world, I would not have been in any position to write this work. 
