...
This thesis aims to document the mathematical progress made around Comon's Conjecture (a question about tensor rank and symmetry). Covered within this text are some attempts made to prove the conjecture in various contexts, published after it was first posited in 2008. The main focus of this work centers around the tools and methodology proposed by Shitov (both from published works \cite{shitov_counterexample_2018} and preprints \cites{shitov_comons_2020,shitov_higher_2024,shitov_higher_2024-1}) that aim to construct a valid counterexample to the conjecture. The culmination of this thesis is an examination of Wang and Seigal's paper \cite{wang_lower_2023} detailing the construction of a valid counterexample in $\reals$. While the existence of a counterexample in $\complex$ is still an open question, this thesis concludes that the ideas detailed within the papers cited  provide a valid pathway to one.

\section*{Acknowledgements and Contribution Statement}
This thesis was written in consultation with Prof. N. Vannieuwenhoven and Dr. D. Taufer. Prof. Vannieuwenhoven provided the initial idea and shaped the overall direction this this thesis took, and Dr. Taufer's guidance over the year helped in developing this project on a solid foundation. I am grateful to both for the structure and feedback they have provided over the course of my interaction with them. Personal contributions to this thesis are detailed in the introduction. Generative AI tools were not used in the writing of this thesis.

This thesis would not exist without friends, family, coworkers and mentors, both in Belgium and from around the world --- I would not be in any position to write this work without them. 
